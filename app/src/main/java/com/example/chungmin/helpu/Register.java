...
public class Register extends HelpUBaseActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    EditText etName, etUsername, etPassword, etRetypePassword, etUserContact, etUserEmail;
    Button btnRegister;

    String strNameEmpty;
    String strUsernameAlreadyExists;
    String strUsernameEmpty;
    String strPasswordEmpty;
    String strPasswordMismatch;
    String strPasswordTooShort;
    String strUserContactEmpty;
    String strUserEmailEmpty;
    String strUserEmailInvalid;

    boolean mIsNameValid = false;
    boolean mIsUsernameValid = false;
    boolean mIsPasswordValid = false;
    boolean mIsUserContactValid = false;
    boolean mIsUserEmailValid = false;
    ...
    public void validateUsername() {
        ...
        if (!username.trim().equals("")) {
            String url = getString(R.string.server_uri) + ((Globals) getApplication()).getIsUsernameAlreadyExists();
            UserServerRequests serverRequest = new UserServerRequests(this);
